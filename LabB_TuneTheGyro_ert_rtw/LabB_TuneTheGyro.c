...
void LabB_TuneTheGyro_initialize(void)
{
  ...
  rtsiSetIsMinorTimeStepWithModeChange(&LabB_TuneTheGyro_M->solverInfo, false);
  rtsiSetIsContModeFrozen(&LabB_TuneTheGyro_M->solverInfo, false);
  ...
  /* External mode info */
  LabB_TuneTheGyro_M->Sizes.checksums[0] = (3596129083U);
  LabB_TuneTheGyro_M->Sizes.checksums[1] = (3388805398U);
  LabB_TuneTheGyro_M->Sizes.checksums[2] = (4142211822U);
  LabB_TuneTheGyro_M->Sizes.checksums[3] = (4081778696U);

  {
    ...
    rteiSetTFinalTicks(LabB_TuneTheGyro_M->extModeInfo, -1);
  }
